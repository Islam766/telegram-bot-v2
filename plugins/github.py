...
def github(m):
    try:
        ...
        delete=bot.send_message(m.chat.id, "_Репозиторий кота_ "
                                "[Тык](https://github.com/evilcatsystem)\n"
                                "_Активный репозиторий_[Тык](https://github."
                                "com/angry-kitty-linux/telegram-bot-v2)",
