...
permission = ['У вас нет прав на использование этой команды',
              ...
              "Все надоели, я в отпуске",
              "Невозможно выполнить команду: Отказано в доступе"]

reply = ['Перешлите сообщение',
         'По-моему где-то сообщение потерялось и до меня не дошло',
         'А сообщение где?',
         'Я бы пошутил про UDP, но боюсь, что не дайдет, '
         'как и ваше пересланное сообщение',
...
admin = ['Я не имею прав трогать админов',
         ...
         'Ну это пиздец, зачем мы админов тронули, ну все, пойду вешаться',
...
shout = ['Крик из толпы',
         ...
         "Хакеры пришли и написали"]

# Фантазии ноль, надо придумать еще
active = ["Так-с. А ну быстро в чат! Прекращай в тихушку сидеть!"]
